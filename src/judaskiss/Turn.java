...
public class Turn {
    ...
    public void start(){
        ...
        if( (!game.findStack("Stack Slot1").isEmpty()  && pickedCard.getStatus().equals(game.findStack("Stack Slot1").peek().getStatus()) ) || (!game.findStack("Stack Slot2").isEmpty()  && pickedCard.getStatus().equals(game.findStack("Stack Slot2").peek().getStatus()) )||(!game.findStack("Stack Slot3").isEmpty()  && pickedCard.getStatus().equals(game.findStack("Stack Slot3").peek().getStatus()) )||(!game.findStack("Stack Slot4").isEmpty()  && pickedCard.getStatus().equals(game.findStack("Stack Slot4").peek().getStatus()) )||(!game.findStack("Player1 Stack").isEmpty()  && pickedCard.getStatus().equals(game.findStack("Player1 Stack").peek().getStatus()) )||(!game.findStack("Player2 Stack").isEmpty()  && pickedCard.getStatus().equals(game.findStack("Player2 Stack").peek().getStatus()) )||(!game.findStack("Player3 Stack").isEmpty()  && pickedCard.getStatus().equals(game.findStack("Player3 Stack").peek().getStatus()) )||(!game.findStack("Player4 Stack").isEmpty()  && pickedCard.getStatus().equals(game.findStack("Player4 Stack").peek().getStatus()) ) ){
